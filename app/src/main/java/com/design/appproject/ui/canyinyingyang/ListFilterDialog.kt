...
import com.design.appproject.databinding.CanyinyingyangFilterDialogLayoutBinding
...
class ListFilterDialog(context: Context) : DrawerPopupView(context) {
    ...
    lateinit var binding: CanyinyingyangFilterDialogLayoutBinding
    ...
    override fun onCreate() {
        ...
        binding.apply {
            ...
            resetBtn.setOnClickListener { //重置
                kaluliStartEt.setText("")
                kaluliEndEt.setText("")
                callBackListener?.invoke(false,null)
            }
            ensureBtn.setOnClickListener { //确定
                params.clear()
                kaluliStartEt.text.toString().isNotNullOrEmpty().yes {
                    params.put("kalulistart",kaluliStartEt.text.toString())
                }
                kaluliEndEt.text.toString().isNotNullOrEmpty().yes {
                    params.put("kaluliend",kaluliEndEt.text.toString())
                }
