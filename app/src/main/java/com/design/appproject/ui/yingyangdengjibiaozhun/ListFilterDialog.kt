...
import com.design.appproject.databinding.YingyangdengjibiaozhunFilterDialogLayoutBinding
...
class ListFilterDialog(context: Context) : DrawerPopupView(context) {
    ...
    lateinit var binding: YingyangdengjibiaozhunFilterDialogLayoutBinding
