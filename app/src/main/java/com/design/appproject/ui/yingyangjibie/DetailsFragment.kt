...
import com.design.appproject.logic.viewmodel.yingyangjibie.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.YingyangjibiecommonDetailsLayoutBinding
 ...
 * 营养级别详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_YINGYANGJIBIE)
class DetailsFragment : BaseBindingFragment<YingyangjibiecommonDetailsLayoutBinding>() {
    ...
    private var mYingyangjibieItemBean=YingyangjibieItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mYingyangjibieItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("yingyangjibie",mId.toString())
    }


    private fun YingyangjibiecommonDetailsLayoutBinding.setInfo(){
        yingyangjibieTv.text = "${mYingyangjibieItemBean.yingyangjibie}"
    }
